Webserver:main.o Server.o Http_conn.o Mimetype.o Packet.o EventLoop.o Epoll.o Channel.o
	g++ -std=c++11 -o Webserver main.o Server.o Http_conn.o Mimetype.o Packet.o EventLoop.o Epoll.o Channel.o -lpthread	
